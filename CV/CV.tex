...
\address{Park Science Center \\ 101 N. Merion Avenue \\ Bryn Mawr, PA 19010, USA} % Address
\address{+1~$\cdot$~(516)~$\cdot$~383~$\cdot$~4817 \\ \href{mailto:earena@brynmawr.edu}{earena@brynmawr.edu} \\ \href{https://evanjarena.github.io}{https://evanjarena.github.io}} % Phone number and email
...
\textbf{Bryn Mawr College} \hfill {\textit{Start Date: 1 August 2024} \\
\textit{Lecturer of Physics and Lab Coordinator} (title at start of appointment)\\
