...
\address{+1~$\cdot$~(516)~$\cdot$~383~$\cdot$~4817 \\ \href{mailto:evan.james.arena@drexel.edu}{evan.james.arena@drexel.edu} \\ \href{https://evanjarena.github.io}{https://evanjarena.github.io}} % Phone number and email
...
\textbf{Invited Talks}\\
``Constraining the dark universe with light bananas''\\
\forceindent Colloquium at the Institute of Cosmology and Gravitation, University of Portsmouth \hfill 9 Nov. 2023\\ 

  
\textbf{Contributed Talks}\\
``The DES Y3 Weak Lensing Flexion Catalogue''\\
\forceindent Dark Energy Survey Fall Collaboration Meeting, NCSA at UI Urbana-Champaign \hfill 10 Oct. 2023\\ 
